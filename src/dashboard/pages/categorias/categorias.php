            ...
            <div class="sidebar">
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                        <a href="../categorias/categorias.php" class="nav-link active">
         ...
         <div class="content-wrapper">
            ...
            <div class="content">
               <div class="container-fluid">
                  <div class="row mb-3">
                     <div class="col-sm-12">
                        <button type="button" class="btn btn-success" id="createCategoryButton" data-toggle="modal" data-target="#editCategoryModal">
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form id="editCategoryForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           <label for="editCategoryImage">Capa Atual</label>
                           <img id="editCategoryCurrentImage" src="" alt="Capa da Categoria" class="img-fluid mb-3" style="display: none;">
                           <p id="editCategoryNoImage" class="text-muted">Sem capa</p>
                        </div>
                        <div class="form-group">
                           <label for="editCategoryImage">Nova Capa (opcional)</label>
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="submit" class="btn btn-primary" id="saveCategoryChanges">Salvar Alterações</button>
                  </div>
               </div>
            </div>
         </div>
      ...
      <script>
         $(document).ready(function () {
            $(document).on('click', '.editar', function () {
               // Define o título do modal como "Editar Categoria"
             $('#editCategoryModalLabel').text('Editar Categoria');
               var categoryId = $(this).data('id');
               var categoryName = $(this).data('nome');
               var categoryImage = $(this).data('capa');
               ...
               if (categoryImage && categoryImage.trim() !== "") {
                  $('#editCategoryCurrentImage').attr('src', '../../assets/img/categorias/' + categoryImage).show();  
                  $('#editCategoryNoImage').hide();  
               } else {
                  $('#editCategoryCurrentImage').hide();  
...
$('#editCategoryModal').on('hidden.bs.modal', function () {
    // Limpa o campo hidden editCategoryId
    $('#editCategoryId').val('');
});
            ...
            var isEditing = $('#editCategoryId').val() !== '';
         
            // Envia uma requisição AJAX para salvar as alterações
            $.ajax({
               url: isEditing ? 'atualiza_categoria.php' : 'criar_categoria.php', 
               type: 'POST',
               data: formData,
               processData: false,
               contentType: false,
         ...
         // Evento para abrir o modal para criar uma nova categoria
         $(document).on('click', '#createCategoryButton', function () {
             $('#editCategoryModalLabel').text('Criar Categoria');
